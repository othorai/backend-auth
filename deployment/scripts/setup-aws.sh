...
aws ecr describe-repositories --repository-names ${AUTH_APP_NAME} 2>/dev/null || \
aws ecr create-repository --repository-name ${AUTH_APP_NAME}
...
aws ecs create-cluster \
    --cluster-name $AUTH_CLUSTER_NAME \
...
aws logs create-log-group --log-group-name "/ecs/${AUTH_APP_NAME}" 2>/dev/null || true
